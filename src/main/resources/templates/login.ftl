		...
		<center>
			<form action="<%=request.getContextPath()%>/admin/login.do" method="POST">
				...
				<ul>
					...
					<li id="j_captcha_li"><span>验证码:</span><input name="j_captcha" class="j_captcha" placeholder="请输入验证码" /><img id="captchaImage" src="<%=request.getContextPath()%>/admin/common/captcha.do?captchaId=${captchaId}" alt="换一张" /></li>
					<li><span></span>
