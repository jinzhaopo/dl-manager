...
import com.yundao.manager.model.manager.User;
...
public class AdminDetailsInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		Object obj = AppContext.getSessionAttr(Constant.CURRENT_ADMIN);
		if (obj == null) {
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
		if (modelAndView != null) {
			...
			if (!StringUtils.startsWith(s, "redirect:"))
				modelAndView.addObject("user", (User) AppContext.getSessionAttr(Constant.CURRENT_ADMIN));
		}
	}
